...
const NotFound = () => (
  <div className="h-screen bg-stone-950 flex flex-col items-center justify-center text-center px-4">
    <h1 className="text-9xl font-serif text-red-600 mb-4">404</h1>
