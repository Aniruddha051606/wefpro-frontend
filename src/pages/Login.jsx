      ...
      <div className="bg-stone-900 p-8 rounded-2xl border border-stone-800 w-full max-w-md shadow-2xl">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
            <input 
                ...
                className="w-full bg-black border border-stone-700 p-4 rounded-lg text-white text-center tracking-widest text-xl focus:outline-none focus:border-red-600 transition"
            />
